...
int main(int argv, char** argc)
{
	...
	disp2DepthMap(disparity, depth_mat, width, height, "disp-left");
	// 保存深度图
	SaveDepthMap(disparity, width, height, path_left);
	// 保存深度点云(x, y, z,disp, r, g, b)
	SaveDepthCloud(bytes_left, disparity, width, height, path_left);
